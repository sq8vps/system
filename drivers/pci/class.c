...
static const char * const PciDeviceName[] = {
    ...
    [PCI_NAME_INDEX(BRIDGE, BRIDGE_ISA)] = "Generic ISA Controller",
    [PCI_NAME_INDEX(BRIDGE, BRIDGE_EISA)] = "Generic EISA Controller",
    [PCI_NAME_INDEX(BRIDGE, BRIDGE_MCA)] = "Generic MCA Controller",
    [PCI_NAME_INDEX(BRIDGE, BRIDGE_PCI)] = "Generic PCI Controller",
    [PCI_NAME_INDEX(BRIDGE, BRIDGE_PCMCIA)] = "Generic PCMCIA Controller",
    [PCI_NAME_INDEX(BRIDGE, BRIDGE_NUBUS)] = "Generic NuBus Controller",
    [PCI_NAME_INDEX(BRIDGE, BRIDGE_CARBUS)] = "Generic CardBus Controller",
    [PCI_NAME_INDEX(BRIDGE, BRIDGE_RACEWAY)] = "Generic Raceway Controller",
    [PCI_NAME_INDEX(BRIDGE, BRIDGE_PCI_2)] = "Generic PCI Controller",
