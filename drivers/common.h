 ...
 */
extern void *memcpy(void *to, const void *from, uint64_t num);
 ...
 */
extern uint64_t alignToPage(uint64_t addr);
 ...
 * \return 10^x
 */
extern uint64_t pow10(uint8_t x);
 ...
 * \return uint32 byte
 */
extern uint32_t bytesToUint32LE(uint8_t *in);
 ...
 * \return uint32 byte
 */
extern uint16_t bytesToUint16LE(uint8_t *in);


extern uint32_t strlen(const uint8_t *s);

extern uint8_t strcmp(const uint8_t *s1, const uint8_t *s2);

extern uint8_t strncmp(const uint8_t *s1, const uint8_t *s2, uint32_t len);
